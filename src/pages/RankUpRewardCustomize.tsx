...
import { useRankUpRewardScreens } from '../hooks/useRankUpRewardScreens';
...
interface RankUpRewardCustomizeProps {
  id?: string;
}
...
export const RankUpRewardCustomize = ({ id }: RankUpRewardCustomizeProps) => {
  ...
  const { saveScreen, loadScreen } = useRankUpRewardScreens();
        ...
        <Box sx={{
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Typography variant="h5" component="h1" fontWeight={600} color="primary">
              Rank Up Reward Screen Designer
            </Typography>
          </Box>
          <Chip
            label="Customization"
