...
import { usePlayerProfileScreens } from '../hooks/usePlayerProfileScreens';
...
interface PlayerProfileCustomizeProps {
  id?: string;
}
...
export const PlayerProfileCustomize = ({ id }: PlayerProfileCustomizeProps) => {
  ...
  const { saveScreen, loadScreen } = usePlayerProfileScreens();
        ...
        <Box sx={{
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Typography variant="h5" component="h1" fontWeight={600} color="primary">
              Player Profile Screen Designer
            </Typography>
          </Box>
          <Chip
            label="Customization"
