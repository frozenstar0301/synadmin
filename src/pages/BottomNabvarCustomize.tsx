...
import { useBottomNavbarScreens } from '../hooks/useBottomNavbarScreens';
...
interface BottomNabvarCustomizeProps {
  id?: string;
}
...
export const BottomNabvarCustomize = ({ id }: BottomNabvarCustomizeProps) => {
  ...
  const { saveScreen, loadScreen } = useBottomNavbarScreens();
