...
import { useSeasonScreens } from '../hooks/useSeasonScreens';
...
interface SeasonCustomizeProps {
  id?: string;
}
...
export const SeasonCustomize = ({ id }: SeasonCustomizeProps) => {
  ...
  const { saveScreen, loadScreen } = useSeasonScreens();
