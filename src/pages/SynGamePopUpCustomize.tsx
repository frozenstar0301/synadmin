...
import { useSynGamePopupScreens } from '../hooks/useSynGamePopupScreens';
...
interface SynGamePopUpCustomizeProps {
  id?: string;
}
...
export const SynGamePopUpCustomize = ({ id }: SynGamePopUpCustomizeProps) => {
  ...
  const { saveScreen, loadScreen } = useSynGamePopupScreens();
        ...
        <Box sx={{
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Typography variant="h5" component="h1" fontWeight={600} color="primary">
              SYN Game Pop Up Screen Designer
            </Typography>
          </Box>
          <Chip
            label="Customization"
