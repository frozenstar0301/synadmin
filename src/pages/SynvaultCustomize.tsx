...
import { useSynvaultScreens } from '../hooks/useSynvaultScreens';
...
interface SynvaultCustomizeCustomizeProps {
  id?: string;
}
...
export const SynvaultCustomize = ({ id }: SynvaultCustomizeCustomizeProps) => {
  ...
  const { saveScreen, loadScreen } = useSynvaultScreens();
