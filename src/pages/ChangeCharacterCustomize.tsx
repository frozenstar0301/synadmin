...
import { useChangeCharacterScreens } from '../hooks/useChangeCharacterScreens';
...
interface ChangeCharacterCustomizeProps {
  id?: string;
}
...
export const ChangeCharacterCustomize = ({ id }: ChangeCharacterCustomizeProps) => {
  ...
  const { saveScreen, loadScreen } = useChangeCharacterScreens();
        ...
        <Box sx={{
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Typography variant="h5" component="h1" fontWeight={600} color="primary">
              Change Character Screen Designer
            </Typography>
          </Box>
          <Chip
            label="Customization"
