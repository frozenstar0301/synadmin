...
import { useChangeSettingScreens } from '../hooks/useChangeSettingScreens';
...
interface ChangeSettingCustomizeProps {
  id?: string;
}
...
export const ChangeSettingCustomize = ({ id }: ChangeSettingCustomizeProps) => {
  ...
  const { saveScreen, loadScreen } = useChangeSettingScreens();
        ...
        <Box sx={{
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Typography variant="h5" component="h1" fontWeight={600} color="primary">
              Change Setting Screen Designer
            </Typography>
          </Box>
          <Chip
            label="Customization"
