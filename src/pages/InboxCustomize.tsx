...
import { useInboxScreens } from '../hooks/useInboxScreens';
...
export const InboxCustomize = ({ id }: InboxCustomizeProps) => {
  ...
  const { saveScreen, loadScreen } = useInboxScreens();
