...
import { useTopNavberScreens } from '../hooks/useTopNavberScreens';
...
interface TopNavbarCustomizeProps {
  id?: string;
}
...
export const TopNavbarCustomize = ({ id }: TopNavbarCustomizeProps) => {
  ...
  const { saveScreen, loadScreen } = useTopNavberScreens();
