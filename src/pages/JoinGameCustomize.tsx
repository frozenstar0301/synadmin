...
import { useJoinGameScreens } from '../hooks/useJoinGameScreens';
...
interface JoinGameCustomizeProps {
  id?: string;
}
...
export const JoinGameCustomize = ({ id }: JoinGameCustomizeProps) => {
  ...
  const { saveScreen, loadScreen } = useJoinGameScreens();
