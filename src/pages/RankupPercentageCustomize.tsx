...
import { useRankUpPercentageScreens } from '../hooks/useRankUpPercentageScreens';
...
interface RankupPercentageCustomizeProps {
  id?: string;
}
...
export const RankupPercentageCustomize = ({ id }: RankupPercentageCustomizeProps) => {
  ...
  const { saveScreen, loadScreen } = useRankUpPercentageScreens();
        ...
        <Box sx={{
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Typography variant="h5" component="h1" fontWeight={600} color="primary">
              Rank Up Percentage Screen Designer
            </Typography>
          </Box>
          <Chip
            label="Customization"
