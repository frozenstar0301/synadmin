...
import { useHistoryScreens } from '../hooks/useHistoryScreens';
...
interface HistoryCustomizeProps {
  id?: string;
}
...
export const HistoryCustomize = ({ id }: HistoryCustomizeProps) => {
  ...
  const { saveScreen, loadScreen } = useHistoryScreens();
