...
import { useSynGameScreens } from '../hooks/useSynGameScreens';
...
interface SynGamesCustomizeProps {
  id?: string;
}
...
export const SynGamesCustomize = ({ id }: SynGamesCustomizeProps) => {
  ...
  const { saveScreen, loadScreen } = useSynGameScreens();
        ...
        <Box sx={{
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Typography variant="h5" component="h1" fontWeight={600} color="primary">
              SYN Games Page Screen Designer
            </Typography>
          </Box>
          <Chip
            label="Customization"
