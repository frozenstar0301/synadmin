...
import { useDailyRewardScreens } from '../hooks/useDailyRewardScreens';
...
interface DailyRewardCustomizeProps {
  id?: string;
}
...
export const DailyRewardCustomize = ({ id }: DailyRewardCustomizeProps) => {
  ...
  const { saveScreen, loadScreen } = useDailyRewardScreens();
