...
import { useLinkEmailScreens } from '../hooks/useLinkEmailScreens';
...
interface LinkEmailCustomizeProps {
  id?: string;
}
...
export const LinkEmailCustomize = ({ id }: LinkEmailCustomizeProps) => {
  ...
  const { saveScreen, loadScreen } = useLinkEmailScreens();
