...
import { useEarnSynPointScreens } from '../hooks/useEarnSynPointScreens';
...
interface EarnSynPointCustomizeProps {
  id?: string;
}
...
export const EarnSynPointCustomize = ({ id }: EarnSynPointCustomizeProps) => {
  ...
  const { saveScreen, loadScreen } = useEarnSynPointScreens();
        ...
        <Box sx={{
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Typography variant="h5" component="h1" fontWeight={600} color="primary">
              Earn SYN Point Screen Designer
            </Typography>
          </Box>
          <Chip
            label="Customization"
