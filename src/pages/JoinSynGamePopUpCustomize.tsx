...
import { useJoinSynGamePopupScreens } from '../hooks/useJoinSynGamePopupScreens';
...
interface JoinSynGamePopUpCustomizeProps {
  id?: string;
}
...
export const JoinSynGamePopUpCustomize = ({ id }: JoinSynGamePopUpCustomizeProps) => {
  ...
  const { saveScreen, loadScreen } = useJoinSynGamePopupScreens();
        ...
        <Box sx={{
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Typography variant="h5" component="h1" fontWeight={600} color="primary">
              Join SYN Game Pop Up Screen Designer
            </Typography>
          </Box>
          <Chip
            label="Customization"
